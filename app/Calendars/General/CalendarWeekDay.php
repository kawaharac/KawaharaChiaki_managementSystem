...
class CalendarWeekDay
{
  ...
  {
    $one_part_frame = ReserveSettings::with('users')->where('setting_reserve', $ymd)->where('setting_part', '1')->first(); //＄ymd=入力値から来ている 予約枠の上限数
    ...
    if ($one_part_frame) { //$one_part_frame に数が入っているとき（0か0でないか）
